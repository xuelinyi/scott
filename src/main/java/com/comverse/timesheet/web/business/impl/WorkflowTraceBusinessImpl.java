...
@Component
public class WorkflowTraceBusinessImpl extends BasicSqlSupport implements WorkflowTraceBusiness {
	private static final Logger log = Logger.getLogger(WorkflowTraceBusinessImpl.class);
	@Autowired
	...
	private Map<String, Object> packageSingleActivitiInfo(ActivityImpl activity, ProcessInstance processInstance,
		...
		log.debug("trace variables: {}"+vars);
	...
	private Task getCurrentTaskInfo(ProcessInstance processInstance) {
		...
		try {
			...
			log.debug("current activity id: {}"+ activitiId);

			currentTask = taskService.createTaskQuery().processInstanceId(processInstance.getId()).taskDefinitionKey(activitiId)
					.singleResult();
			log.debug("current task for processInstance: {}"+ToStringBuilder.reflectionToString(currentTask));

		} catch (Exception e) {
			log.error("can not get property activityId from processInstance: {}"+ processInstance);
		}
		return currentTask;
	}                 
	/**

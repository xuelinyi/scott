            ...
            <section class="wrapper site-min-height">
               <section class="panel">
                  <header class="panel-heading">
                     <span class="label label-primary">请假已结束的流程实例列表</span>
                     ...
                     <div class="adv-table editable-table ">
                        ...
                        <table class="table table-striped table-hover table-bordered" id="editable-sample">
                           <display:table id="leave" name="leaveList" pagesize="5" class="table">
							...
							<display:column property="realityStartTime" title="实际开始时间" />
							<display:column property="realityEndTime" title="实际结束时间" />
							<display:column property="historicProcessInstance.startTime" title="流程开始时间" />
							<display:column property="historicProcessInstance.endTime" title="流程结束时间" />
							<display:column property="historicProcessInstance.deleteReason" title="流程结束原因" />
							<display:column property="processDefinition.version" title="流程版本" />
						</display:table>
                        </table>
                     </div>
                  </div>

            ...
            <section class="wrapper site-min-height">
               <section class="panel">
                  <header class="panel-heading">
                     <span class="label label-primary">系统日志管理</span>
                  ...
                  <div class="panel-body">
                     <div class="adv-table editable-table ">
                        ...
                        <table class="table table-striped table-hover table-bordered" id="editable-sample">
                           <display:table id="admiinLog" name="adminLogList" requestURI="/system/findAdminLogList" pagesize="20" class="table">
							...
							<display:column property="levelStr" title="级别" />
							<display:column property="account" title="操作员" />
							<display:column property="ip" title="IP" />
							<display:column property="descrition" title="操作信息" />
						</display:table>
                        </table>
                     </div>
                  </div>

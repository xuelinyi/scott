            ...
            <section class="wrapper site-min-height">
               <section class="panel">
                  <header class="panel-heading">
                     <span class="label label-primary">运行中流程列表</span>
                  ...
                  <div class="panel-body">
                     <div class="adv-table editable-table ">
                        ...
                        <table class="table table-striped table-hover table-bordered" id="editable-sample">
                           <display:table id="instance" name="runtimeInstanceList" pagesize="5" class="table">
	                        <display:setProperty name="sort.amount" value="list"></display:setProperty>
	                        <display:column property="id" title="执行ID" sortable="true"/>
							<display:column property="processInstanceId" title="流程实例ID" sortable="true"/>
							<display:column property="processDefinitionId" title="流程定义ID" />
							<display:column title="当前节点">
								<a class="trace" href='#' pid="${instance.id }" title="点击查看流程图">当前节点</a>
							</display:column>
							<display:column property="suspended" title="是否挂起" />
						</display:table>
                        </table>
                     </div>
                  </div>

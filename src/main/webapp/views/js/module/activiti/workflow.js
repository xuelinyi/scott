function graphTrace(options) {
    ...
    $('#changeImg').live('click', function() {
        ...
        $('<div/>', {
            ...
            html: "<img src='../trace/auto?executionId=" + opts.pid + "' />"
    ...
    // 获取图片资源
    var imageUrl = "../resource/process-instance?pid=" + opts.pid + "&type=image";
    //
    $.getJSON('../process/trace?pid=' + opts.pid, function(infos) {
        var positionHtml = "";
